...
public class C02_ExplicitlyWait  {
    ...
    public void explicitWaitTest(){
        ...
        WebElement itsGoneMesaj=wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//p[@id='message']")));
        Assert.assertTrue(itsGoneMesaj.isDisplayed());
        ...
        WebElement istBackMesaj=wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//p[@id='message']")));
        Assert.assertTrue(istBackMesaj.isDisplayed());
    }
