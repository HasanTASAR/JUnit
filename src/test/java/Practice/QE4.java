...
public class QE4 {
    ...
    public void kiwiTest() throws InterruptedException {
        ...
        // Cookies i reddedin
        WebElement cookies= driver.findElement(By.xpath("(//div[@class=\"ButtonPrimitiveContent__StyledButtonPrimitiveContent-sc-1r81o9a-0 ULnUg\"])[1]"));
        cookies.click();
        ...
        // Sag ust kisimdan dil ve para birimi secenegini Turkiye ve TL olarak secin
        WebElement dilsecimi= driver.findElement(By.xpath("(//div[@class=\"CountryFlag__StyledShadow-sc-ltfn8f-2 jxwlrI\"])[1]"));
        dilsecimi.click();
